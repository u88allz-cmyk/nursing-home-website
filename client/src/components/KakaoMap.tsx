        ...
        ps.keywordSearch('해와달 요양원 양주', function(data: any, status: any) {
          if (status === window.kakao.maps.services.Status.OK) {
            ...
            const infowindow = new window.kakao.maps.InfoWindow({
              content: '<div style="padding:8px 10px;font-size:14px;color:#000;font-weight:bold;white-space:nowrap;text-align:center;min-width:auto;width:auto;display:inline-block;">해와달요양원</div>'
            });
